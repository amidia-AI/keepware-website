...
export const TYPEMASTER_APP: AppItem = {
  ...
  longDescription: 'Engineered for developers, writers, and power users who demand private, instant dictation. Unlike cloud-tethered subscription services, TypeMaster processes every phoneme locally on your CPU or GPU. Your microphone data never touches an external server, your system works fully offline, and you only ever pay once for a lifetime license.',
  priceUsd: 7.00,
  platforms: ['Windows'],
  version: 'v1.4.2',
  rating: 4.98,
